...
#write_csv2(prenoms, here("Tutorials/04/names.csv") )
prenoms <- read_csv2(here("Tutorials/03/names.csv"))

checker <- function(label, user_code, check_code, envir_result, evaluate_result, ...) {
  list(message = check_code, correct = TRUE, location = "append")
}
tutorial_options( exercise.checker = checker) #exercise.timelimit = 60
...
## Bienvenue `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
## Data Science avec les Prenoms `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
Votre objectif dans cette section est de répéter ce processus pour un autre prénom, par exemple le votre. 
En cours de route, vous apprendrez un ensemble de fonctions qui isolent les informations dans un jeu de données.
...
### Quiz select() `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
### Combinaison de tests `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
* Les prénoms qui ont été données à exactement 5 ou 6 enfants en 1990
* Les prénoms Marie, Mariette ou Marine

```{r filter-2, exercise = TRUE, exercise.eval = FALSE, exercise.setup = "bnames"}
filter(prenoms, name == "Julie" | name == "Antoinette")
```

```{r filter-2-solution}
filter(prenoms, name == "Agnès", sex == "F")
filter(prenoms, n == 5 | n == 6, year == 1990)
...
### Deux erreurs courantes supplémentaires - Récapitulatif `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
```{r arrange-2, exercise = TRUE, exercise.eval = FALSE}
arrange(prenoms, n)
```
...
```{r arrange-3, exercise = TRUE, exercise.eval = FALSE}
...
### Quiz arrange() `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
## Pipe `%>%`  `r fa(name = "chalkboard-teacher", fill = "darkorange")`
...
### Récapitulatif `r fa(name = "chalkboard-teacher", fill = "darkorange")`
