...
```{r select-1, exercise = TRUE, exercise.eval = FALSE, }
...
+===================+=============================================================================+=====================+
| **&**             | Est-ce que les conditions`A` et `B` sont *toutes les deux* vraies ?         | `A & B`             |
+-------------------+-----------------------------------------------------------------------------+---------------------+
...
```{r filter-2, exercise = TRUE, exercise.eval = FALSE, }
...
`arrange()` renvoie toutes les lignes d'un jeu données réorganisées par les valeurs d'une colonne. Comme avec `select()`, le premier argument de `arrange()` doit être un jeu de données et les arguments restants sont les noms des colonnes.
